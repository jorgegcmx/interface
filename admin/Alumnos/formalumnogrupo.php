...
include_once '../conexion/Conexion.php';
	...
	$filas = $estatus->get_gru_tipo($tipogrupo);
...
?>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Registrar en Grupo</h1>
			</div>
		</div><!--/.row-->
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-6">
							<form role="form" method="POST" action="alumnosygrupos.php"	>	
								...
								<div class="form-group">
									...
									<select  name="grupos_idgrupos" required class="form-control">
										 <option value="" ></option>
                                       	<?php while($data=$filas->fetchObject()){ ?>		
	                                   <option value="<?php echo $data->idgrupos; ?>" ><?php echo $data->grupo;?>-<?php echo $data->tipodegrupo;?></option>
                                         <?php } ?>
									</select>
								</div>
									<div class="form-group">
									...
									<select  name="periodosescolares_idperiodos" required class="form-control">
										<option value="" ></option>
		                                 ...
		                                 <option value="<?php echo $data->idperiodos; ?>"><?php echo "$data->periodoescolar"; echo "_$data->anio";?></option>
                                         <?php } ?>
									</select>
								</div>

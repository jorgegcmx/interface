					...
					<div class="panel-body">
						<div class="col-md-6">
							<form role="form" method="POST" action="agregar.php"	>	
                               <?php if(isset($id)){ echo "<input type='hidden' value='$fila->idmaterias' name='id'>"; }?>							
								<div class="form-group">
									<label>Materia</label>
									<input type="text" name="materia" class="form-control" required value="<?php  if(isset($id)){echo  $fila->materia;} ?>">
								</div>
								...
								<div class="form-group">
									...
									<select  name="tipodegrupo_idtipodegrupo" class="form-control">
	                                   ...
	                                   <option value="<?php echo $data->idtipodegrupo; ?>" <?php if(isset($id)){if ($fila->id_tipo == $data->idtipodegrupo){?>selected<?php }} ?>><?php echo $data->tipodegrupo; ?></option>
                                         <?php } ?>
									</select>
								</div>					
